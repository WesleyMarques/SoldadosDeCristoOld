...
public class ConnectionMySql {
   ...
   private Connection getConexaoMySQL(String uName, String sName, String DB,
         String pw) throws DAOException {
      ...
      try {
         ...
         throw new DAOException("Drive not found!");
      } catch (SQLException e) {
         // Não conseguindo se conectar ao banco
         throw new DAOException("Database connect not is possible. Try again!");
      }
   }
