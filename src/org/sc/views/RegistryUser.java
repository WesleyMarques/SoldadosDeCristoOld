 ...
 * @author Wesley
 */
public class RegistryUser extends SwitchablePanel {
    ...
    * @param frame
    */
   public RegistryUser(Window frame) {
      super(frame, false);
      initComponents();
   }
   ...
   // <editor-fold defaultstate="collapsed"
    ...
    private void initComponents() {
        ...
        personaldata.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "Dados Pessoais", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
   ...
   private void saveButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_saveButtonMouseClicked
      ...
      try {
         ...
         userRegistry = new UserRegistry(registryAux, nomeText.getText(),
               warNameText.getText(), Integer.parseInt(rgText.getText()),
               Integer.parseInt(batOption.getName()),
               patOption.getSelectedIndex(), "Ativado", birthDate.getText(),
               photoPath, mBox.isSelected() ? UserRegistry.MAN
                     : UserRegistry.WOMAN, bloddTypeOption.getSelectedItem()
                     .toString(),
               cpfText.getText(), civilStatusOptions.getSelectedItem()
                     .toString(),
               schoolingBox.getSelectedItem().toString(),
               occupationText.getText(), nacText.getText(), payFormBox
                     .getSelectedItem().toString(),
               obsText.getText(), fatherText.getText(), motherText.getText(),
               streetText.getText(), numberText.getText(),
               complementText.getText(),
               Integer.parseInt(cepText.getText()), districtText.getText(),
               cityText.getText(), stateText.getText(), countryText.getText(),
               contacts, emailText.getText(), questionario);
   ...
   private void setPhones(ContactUsers contacts) {
      ...
      } else if (phoneFormat2.getText().length() > 10) {
         contacts.add("fone", phoneFormat2.getText(),
               typePhone2.getSelectedItem() + "");
      } else if (phoneFormat3.getText().length() > 10) {
